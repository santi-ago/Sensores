// ======================================================================
// Practica_1.2.v generated from TopDesign.cysch
// 11/30/2021 at 08:47
...
module top ;
	...
	wire [0:0] tmpOE__Pin_seguidor_net;
	wire [0:0] tmpFB_0__Pin_seguidor_net;
	wire [0:0] tmpIO_0__Pin_seguidor_net;
	wire [0:0] tmpINTERRUPT_0__Pin_seguidor_net;
	electrical [0:0] tmpSIOVREF__Pin_seguidor_net;

	cy_psoc3_pins_v1_10
		#(.id("9d90c101-3081-44f2-a98b-4accb7d4ed93"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Pin_seguidor
		 (.oe(tmpOE__Pin_seguidor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_seguidor_net[0:0]}),
		  .analog({Net_73}),
		  .io({tmpIO_0__Pin_seguidor_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_seguidor_net),
		  .interrupt({tmpINTERRUPT_0__Pin_seguidor_net[0:0]}),
		  .annotation({Net_79}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_seguidor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    OpAmp_v1_90_4 Opamp_3 (
        .Vminus(Net_51),
        .Vout(Net_31),
        .Vplus(Net_72));
    defparam Opamp_3.Mode = 0;

	wire [0:0] tmpOE__Pin_suma_net;
	wire [0:0] tmpFB_0__Pin_suma_net;
	wire [0:0] tmpIO_0__Pin_suma_net;
	wire [0:0] tmpINTERRUPT_0__Pin_suma_net;
	electrical [0:0] tmpSIOVREF__Pin_suma_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_suma
		 (.oe(tmpOE__Pin_suma_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_suma_net[0:0]}),
		  .analog({Net_85}),
		  .io({tmpIO_0__Pin_suma_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_suma_net),
		  .interrupt({tmpINTERRUPT_0__Pin_suma_net[0:0]}),
		  .annotation({Net_84}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_suma_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_sensor_net;
	wire [0:0] tmpFB_0__Pin_sensor_net;
	wire [0:0] tmpIO_0__Pin_sensor_net;
	wire [0:0] tmpINTERRUPT_0__Pin_sensor_net;
	electrical [0:0] tmpSIOVREF__Pin_sensor_net;

	cy_psoc3_pins_v1_10
		#(.id("a5b3cc17-8135-48c6-b3cf-3e40522c1da0"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Pin_sensor
		 (.oe(tmpOE__Pin_sensor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_sensor_net[0:0]}),
		  .analog({Net_29}),
	...
	wire [0:0] tmpOE__Pin_vplus_net;
	wire [0:0] tmpFB_0__Pin_vplus_net;
	wire [0:0] tmpIO_0__Pin_vplus_net;
	wire [0:0] tmpINTERRUPT_0__Pin_vplus_net;
	electrical [0:0] tmpSIOVREF__Pin_vplus_net;

	cy_psoc3_pins_v1_10
		#(.id("2bcbd02b-b724-4be4-89df-cc5fb72b9404"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_vplus
		 (.oe(tmpOE__Pin_vplus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_vplus_net[0:0]}),
		  .analog({Net_72}),
		  .io({tmpIO_0__Pin_vplus_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_vplus_net),
		  .interrupt({tmpINTERRUPT_0__Pin_vplus_net[0:0]}),
		  .annotation({Net_71}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_vplus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_vmin_net;
	wire [0:0] tmpFB_0__Pin_vmin_net;
	wire [0:0] tmpIO_0__Pin_vmin_net;
	wire [0:0] tmpINTERRUPT_0__Pin_vmin_net;
	electrical [0:0] tmpSIOVREF__Pin_vmin_net;

	cy_psoc3_pins_v1_10
		#(.id("1cc3c092-d691-421a-9f46-e75c029a1f2f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_vmin
		 (.oe(tmpOE__Pin_vmin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_vmin_net[0:0]}),
		  .analog({Net_51}),
		  .io({tmpIO_0__Pin_vmin_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_vmin_net),
		  .interrupt({tmpINTERRUPT_0__Pin_vmin_net[0:0]}),
		  .annotation({Net_30}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_vmin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_vout_net;
	wire [0:0] tmpFB_0__Pin_vout_net;
	wire [0:0] tmpIO_0__Pin_vout_net;
	wire [0:0] tmpINTERRUPT_0__Pin_vout_net;
	electrical [0:0] tmpSIOVREF__Pin_vout_net;

	cy_psoc3_pins_v1_10
		#(.id("0d8f2012-023c-4632-8130-b3243b9ac88f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_vout
		 (.oe(tmpOE__Pin_vout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_vout_net[0:0]}),
		  .analog({Net_31}),
		  .io({tmpIO_0__Pin_vout_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_vout_net),
		  .interrupt({tmpINTERRUPT_0__Pin_vout_net[0:0]}),
		  .annotation({Net_87}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_vout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
